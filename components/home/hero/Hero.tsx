...
const Hero = () => {
  ...
  return (
    <div className="relative flex justify-center md:justify-start items-center p-9 h-[88vh] md:h-[90vh] w-screen">
      <motion.form
        className="w-[50%] h-[90%] md:w-[70%] md:h-[80%] max-h-[400px] md:max-h-[500px] bg-white rounded-md p-4 min-w-[100%] md:min-w-[30vw] md:max-w-[500px] flex flex-col gap-2 overflow-hidden z-50"
        initial={{
          x: "-100vw",
        }}
        animate={{
